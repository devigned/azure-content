...
<div class="dev-center-tutorial-selector sublanding"><a href="/documentation/articles/powershell-azure-resource-manager.md" title="Windows PowerShell" class="current">Windows PowerShell</a><a href="/documentation/articles/azure-cli-azure-resource-manager.md" title="Azure CLI">Azure CLI</a></div>
...
- [Using the Azure Command-Line Interface with the Resource Manager](azure-cli-azure-resource-manager.md): Learn how to create and manage resource groups with the Azure CLI.
