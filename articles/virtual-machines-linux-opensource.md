...
1. [The Basics: Azure Command-Line Interface (Azure CLI)](azure-cli.md)
...
19. [Blogging the Basics: Automate Provisioning Linux on Azure with Azure CLI, jhawk](http://blogs.technet.com/b/keithmayer/archive/2014/11/24/step-by-step-automated-provisioning-for-linux-in-the-cloud-with-microsoft-azure-xplat-cli-json-and-node-js-part-1.aspx)
19. [Create a multi-VM deployment using the Azure x-plat cli](virtual-machines-create-multi-vm-deployment-azure-cli.md)
...
1. [Create a multi-VM deployment using the Azure CLI](virtual-machines-create-multi-vm-deployment-azure-cli.md)
...
1. Docker
	...
	- [Using the Docker VM Extension from the Azure Command-line Interface (Azure CLI)](virtual-machines-docker-with-azure-cli.md)
