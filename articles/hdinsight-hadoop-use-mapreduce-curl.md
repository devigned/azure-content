...
You can list and download these files by using the <a href="../azure-cli/" target="_blank">Azure Command-Line Interface (Azure CLI)</a>. For example, to list files in the **example/curl**, use the following command:
