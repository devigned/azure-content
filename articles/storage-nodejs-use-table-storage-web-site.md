...
The steps in this section use the Azure Command-Line Interface to create a new web app in App Service, and then use Git to deploy your application. To perform these steps you must have an Azure subscription.
...
To get started, first install the [Azure CLI](Azure CLI).
