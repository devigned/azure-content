<properties
	pageTitle="Manage Hadoop clusters using Azue Command-Line Interface | Azure"
	description="Learn how to use the Azure Command-Line Interface to manage Hadoop clusters in HDIsight on any platform that supports Node.js, including Windows, Mac, and Linux."
	services="hdinsight"
	editor="cgronlun"
	manager="paulettm"
	authors="mumian"
...
Learn how to use the Azure Command-Line Interface (Azure CLI) to manage Hadoop clusters in Azure HDInsight. The command-line tool is implemented in Node.js. It can be used on any platform that supports Node.js, including Windows, Mac, and Linux.

The command-line tool is open source. The source code is managed in GitHub in the <a href= "https://github.com/Azure/azure-xplat-cli">Azure CLI repository</a>.

This article covers only using the Azure CLI from Windows. For a general guide on how to use the Azure CLI, see [How to use the Azure CLI][azure-command-line-tools].
