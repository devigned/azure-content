...
# Managing Role-Based Access Control with Azure Command-Line Interface (Azure CLI) #

<div class="dev-center-tutorial-selector sublanding"><a href="/documentation/articles/role-based-access-control-powershell.md" title="Windows PowerShell" class="current">Windows PowerShell</a><a href="/documentation/articles/role-based-access-control-azure-cli.md" title="Azure CLI">Azure CLI</a></div>
...
- Azure CLI version 0.8.8 or later. To install the latest version and associate it with your Azure subscription, see [Install and Configure the Azure CLI](azure-cli.md).
- Please also read the following tutorials to get familiar with set up and using Azure Resource Manager in Azure CLI: [Using the Azure CLI with the Resource Manager](azure-cli-azure-resource-manager.md)
...
For more information, please refer to [Using the Azure CLI with the Resource Manager](azure-cli-azure-resource-manager.md)
...
For more information, please refer to [Install and Configure the Azure CLI](azure-cli.md).
...
- [Install and Configure the Azure CLI](azure-cli.md)
- [Using the Azure CLI with the Resource Manager](azure-cli-azure-resource-manager.md)
