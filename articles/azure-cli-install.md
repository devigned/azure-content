<properties
	pageTitle="Install Azure Command-Line Interface"
	description="Install the Azure Command-Line Interface to start using Azure Services"
	editor="tysonn"
	manager="timlt"
	documentationCenter=""
	authors="dsk-2015"
...
This document describes how to install the Azure Command-Line Interface (Azure CLI) on Windows, Mac, and Linux. The Azure CLI provides a set of open source shell-based commands for managing resources on Microsoft Azure.

> [AZURE.NOTE] If you've already installed the Azure CLI, connect the Azure CLI with your Azure resources. For more, see [How to connect to your Azure Subscription](azure-cli.md#configure).

The Azure CLI is written in JavaScript, and requires [Node.js](https://nodejs.org). It is implemented using the [Azure SDK for Node](https://github.com/azure/azure-sdk-for-node), and released under an Apache 2.0 license. The project repository is located at [Azure CLI on GitHub](https://github.com/Azure/azure-xplat-cli).

<a id="install"></a>
## How to install the Azure Command-Line Interface

There are two ways to install the Azure CLI.
...
Now you are ready! To start using Azure CLI and connect to Azure, see [Using the Azure Command-Line interface](azure-cli.md#configure).

<a id="additional-resources"></a>
## Additional resources

* For more information on Azure CLI, download source code, report problems, or contribute to the project, visit the [Azure CLI on GitHub](https://github.com/Azure/azure-xplat-cli).
