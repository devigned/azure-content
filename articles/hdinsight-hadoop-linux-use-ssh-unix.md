<properties
   pageTitle="Use SSH keys with Hadoop on Linux-based HDInsight from Linux, Unix, or OS X | Azure"
...
* <a href="../azure-cli/" target="_blank">Azure Command-line Interface</a>.
...
* **Azure Command-Line Interface (Azure CLI)** - Uses command-line commands to create the cluster.
...
You can use the <a href="../azure-cli/" target="_brad">Azure Command-Line Interface</a> to create a new cluster by using the `azure hdinsight cluster create` command.
